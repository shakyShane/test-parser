...
Tokenizer.prototype._parse = function () {
    ...
    while (this._index < this._buffer.length && this._running) {
        ...
        /**
         * If we're on a newline, call the newline fn
         */
        if (c === '\n' || c === '\r') {
            this._line++;
            this._col = 0;
...
Tokenizer.prototype._stripLeft = function (c) {
    if (this._ws === this._col) {
        return this._ws
    }
    return 0;
};
...
Tokenizer.prototype._stateText = function (c) {
    if (c === ld) {
        if (this._index > this._sectionStart) {
            this._cbs.ontext(this._getSection(), this._loc(), this._stripLeft());
        }
        this._state = LD;
...
Tokenizer.prototype._stateBeforeLD = function (c) {
    if (c === ld) {
        ...
        //if (this._ws === this._col - 1) {
        //    // emit strip left here
        //}

        //console.log('stopping at', this._ws, c, this._buffer.charAt(this._index - 1), this._buffer.charAt(this._index + 1));
    }
};
...
module.exports.parse = function (string, cbs, opts) {
    var t = new Tokenizer(opts || {}, cbs);
    t.write(string);
    return t;
};
